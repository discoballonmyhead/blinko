...
export function PrivacyPage() {
    return (
        <div style={{ minHeight: "100vh", background: "#030814", padding: "120px 24px 80px" }}>
            <div style={{ maxWidth: 760, margin: "0 auto" }}>
                <Link to="/" style={{ color: "#00C2FF", fontSize: 13, textDecoration: "none", display: "inline-flex", alignItems: "center", gap: 6, marginBottom: 48, opacity: 0.7 }}>
                    &larr; Back to home
                </Link>
                <h1 style={{ fontFamily: "Syne, sans-serif", fontWeight: 800, fontSize: "clamp(2rem,4vw,3rem)", color: "#fff", marginBottom: 12 }}>
                    Privacy Policy
                </h1>
                <p style={{ color: "rgba(255,255,255,0.3)", fontSize: 14, marginBottom: 56 }}>
                ...
                {[
                    ...
                    <div key={section.title} style={{ marginBottom: 40 }}>
                        <h2 style={{ fontFamily: "Syne, sans-serif", fontWeight: 700, fontSize: "1.15rem", color: "#fff", marginBottom: 12 }}>
                            {section.title}
                        </h2>
                        <p style={{ color: "rgba(255,255,255,0.5)", fontSize: "0.95rem", lineHeight: 1.85 }}>
                            {section.body}
                        </p>
                    </div>
                ))}
